      ...
      <div v-if="showHeight">
        ...
        <div class="mb_20">
          ...
          <div v-if="coupon" class="padd _checkBox sd_white">
            <van-checkbox class="inblock" v-for=" (item,index) in 4" :key="'inblock_'+index" v-model="checked" shape="square" icon-size="14">优惠标签</van-checkbox>
          </div>
          <div class="_row flex_rowBetwen">
          ...
          <div v-if="coupon" class="padd _checkBox sd_white">
            <van-checkbox class="inblock" v-for=" (item,index) in 4" :key="'inblock_'+index" v-model="checked" shape="square" icon-size="14">服务承诺</van-checkbox>
          </div>
        </div>
        <!-- 最小定量 -->
        <div class="mb_20">
...
import classFly from "./classFly.vue"
