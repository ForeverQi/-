...
class GeetestLib
{
    ...
    {
        $data      = array('gt' => $this->captcha_id, 'new_captcha' => $new_captcha);
    ...
    private function success_process($challenge)
    {
        ...
        $result         = array('success' => 1, 'gt' => $this->captcha_id, 'challenge' => $challenge, 'new_captcha' => 1);
    ...
    private function failback_process()
    {
        ...
        $result         = array('success' => 0, 'gt' => $this->captcha_id, 'challenge' => $challenge, 'new_captcha' => 1);
        $this->response = $result;
    }
    ...
    public function success_validate($challenge, $validate, $seccode, $param, $json_format = 1)
    {
        ...
        $query = array("seccode" => $seccode, "timestamp" => time(), "challenge" => $challenge, "captchaid" => $this->captcha_id, "json_format" => $json_format, "sdk" => self::GT_SDK_VERSION);
    ...
    private function send_request($url)
    {
        ...
        if (function_exists('curl_exec')) {
            ...
            $opts    = array('http' => array('method' => "GET", 'timeout' => self::$connectTimeout + self::$socketTimeout,));
